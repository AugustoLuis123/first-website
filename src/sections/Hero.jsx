...
const Hero = () => {
  return (
    <section id="home" className="relative w-full justify-center max-container-no-margin ">
      ...
      <div className="absolute z-20 max-container-no-margin px-6 py-20 flex flex-col justify-center w-full h-full text-center bg-black bg-opacity-60">
        <h1 className="text-4xl sm:text-7xl md:text-7xl lg:text-8xl bg-gradient-to-b from-hero1 via-hero2 to-hero3 bg-clip-text text-transparent font-bold font-poppins">
